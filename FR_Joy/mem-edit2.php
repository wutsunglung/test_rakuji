										...
										<div class="m-sm-4">
											<form name="form1" method="post" novalidate onsubmit="checkForm(); return false;">
												...
												<div class="mb-3">
													...
													<input class="form-control form-control-lg" type="text" id="name" name="Mname" value="<?=$row['name']?>" required  />
                                                    
												</div>
												<div class="mb-3">
													<label for="identity">身分證</label>
													<input class="form-control form-control-lg" type="text" id="identity" name="Midentity" value="<?=$row['name']?>" >
												</div>
												<div class="mb-3">
												...
												<div class="mb-3">
													...
													<input type="date" class="form-control" id="birthday" name="Mbirthday">
												</div>
												<div class="mb-3">
